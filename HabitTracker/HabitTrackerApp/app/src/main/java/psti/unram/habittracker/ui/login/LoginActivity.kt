...
import psti.unram.habittracker.MainActivity
...
import psti.unram.habittracker.databinding.ActivityLoginBinding
    ...
    private fun setupAction() {
        binding.loginButton.setOnClickListener {
            ...
            AlertDialog.Builder(this).apply {
                setTitle("Yeah!")
                setMessage("Anda berhasil login. Selamat datangg!!")
